...
Darwin.java is responsible for running the actual simulation whereas the other files are classes 
used for each component of the virtual world, i.e. species.java.
``
